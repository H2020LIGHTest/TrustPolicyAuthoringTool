...
import eu.lightest.tpat.mvc.controller.DetailControllers.DetailDelegationController;
...
public class DetailDelegationView extends ADetailView {
  ...
  private DetailDelegationController mController = new DetailDelegationController(this);
